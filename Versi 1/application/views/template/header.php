...
<head>
  ...
  <title>Admin Pusat Koperasi</title>
  ...
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?=base_url();?>asset/css/tambahan.css">
  <!-- Date Picker -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>P</b>KP</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b>PUSKOP</span>
    </a>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          <a href="<?=site_url('anggota')?>">
            <i class="glyphicon glyphicon-briefcase"></i> <span>Data Anggota</span>
          </a>
          <a href="<?=site_url('barang')?>">
            <i class="glyphicon glyphicon-briefcase"></i> <span>Data Barang</span>
          </a>
          <a href="<?=site_url('penjualan/data_penjualan')?>">
            <i class="glyphicon glyphicon-briefcase"></i> <span>Data Penjualan</span>
          </a>
          <a href="<?=site_url('home/logout')?>">
            <i class="glyphicon glyphicon-briefcase"></i> <span>Logout</span>
          </a>
  
          <!-- <ul class="treeview-menu">
            <li class="active"><a href="c_resto"><i class="fa fa-play"></i> Restoran</a></li>
            <li><a href="c_veres"><i class="fa fa-play"></i> Verify Restoran</a></li>
          </ul> -->
        </li>
